...
export default {
  common: {
    ...
    'confirm-action-delete': 'Bạn có muốn tiếp tục ?',
    order: 'Thứ tự',
    create: 'Thêm',
    save: 'Lưu',
    cancel: 'Hủy',
    ...
    upload: {
      ...
      'drop-or-select-file': 'Kéo thả hoặc chọn hình',
    ...
    thanks: 'Lộc Mobile - Thank you !',
    'opt-required': 'Vui lòng nhập mã OTP gồm 6 chữ số',
    'send-back': 'Gửi lại',
    confirm: 'Xác nhận'
  },
  home: {
    'page-title': 'Điện thoại di dộng chính hãng và phụ kiện | Loc Mobile',
    cart: 'Giỏ hàng',
  ...
  account: {
    'page-title': 'Account | Loc Mobile',
    info: 'Thông tin tài khoản',
    order: 'Đơn hàng',
    orderHandle: 'Đơn hàng được xử lí bởi',
    'order-cancel': 'Huỷ đơn hàng',
    'order-cancelled': 'Huỷ đơn hàng thành công',
  ...
  cart: {
    'page-title': 'Giỏ hàng | Loc Mobile',
    title: 'Giỏ hàng',
  ...
  order: {
    'page-title': 'Đơn hàng | Loc Mobile',
    'dashboard-page-title': 'Quản lý Đơn hàng | Loc Mobile',
  ...
  auth: {
    'page-title': {
      login: 'Đăng nhập | Loc Mobile',
      register: 'Đăng ký | Loc Mobile',
      'reset-password': 'Đặt lại mật khẩu | Loc Mobile',
    ...
    'account-verify': 'Xác nhận thành công!',
    password: 'Mật khẩu',
    ...
    'reset-password-desc': 'Vui lòng nhập email liên kết với tài khoản của bạn để xác minh',
    ...
    'accept-terms': 'Khi đăng ký, bạn đã đồng ý với Loc Mobile về',
    tos: 'Điều khoản sử dụng',
    'privacy-policy': 'Chính sách bảo mật',

    'register-salutation': 'Gia nhập Loc Mobile ngay hôm nay',
    ...
    'send-otp-desc': 'Vui lòng kiểm tra email để lấy mã xác thực',
    'set-new-password': 'Đặt mật khẩu mới',
    'set-new-password-success': 'Đặt lại mật khẩu mới thành công',
    'verify-success': 'Xác nhận thành công',
    'not-active': 'Tài khoản chưa xác thực'
  },
  dashboard: {
    ...
    'updated-at': 'Ngày sửa',
    categories: {
      'page-title': 'Quản lý Danh mục | Loc Mobile',
    ...
    brands: {
      'page-title': 'Quản lý Thương hiệu | Loc Mobile',
      title: 'Thương hiệu',
    ...
    discounts: {
      'page-title': 'Quản lý Giảm giá | Loc Mobile',
      title: 'Khuyến mãi',
    ...
    users: {
      'page-title': 'User management | Loc Mobile',
      title: 'Người dùng',
      ...
      heading: 'User List',
      'search-user-placeholder': 'Tìm user...',
      detail: 'Chi tiết',
    ...
    comments: {
      ...
      'signin-write-comment': 'Đăng nhập để bình luận',
    ...
    products: {
      ...
      'name-validation': 'Tên sản phẩm bắt buộc',
      'name-validation-len': 'Tên sản phẩm từ 6 and 25 ký tự'
    }
  },
  products: {
    fee: 'Giá liên hệ',
    'page-title': 'Quản lý sản phẩm | Loc Mobile',
    title: 'Sản phẩm',
    ...
    'search-product-notfound': 'Không tìm thấy sản phẩm',
    add: 'Thêm sản phẩm',
    create: 'Thêm sản phẩm',
    save: 'Lưu lại',
    'add-title': 'Ecommerce: Thêm sản phẩm | Loc Mobile',
    'add-success': 'Thêm sản phẩm mới thành công',
    edit: 'Chỉnh sửa sản phẩm',
    'edit-title': 'Ecommerce: Sửa sản phẩm | Loc Mobile',
    delete: 'Xóa sản phẩm',
    'confirm-delete': 'Bạn có muốn xoá sản phẩm - {{nameInfo}}?',
    name: 'Tên sản phẩm',
    'name-validation': 'Tên sản phẩm bắt buộc',
    desc: 'Mô tả sản phẩm',
    'desc-validation': 'Mô tả sản phẩm bắt buôc',
    price: 'Giá',
    'price-validation': 'Vui lòng nhập giá tiền',
    'market-price': 'Giá thị trường',
    'market-price-validation': 'Vui lòng nhập giá thị trường',
    'market-price-validation1': 'Giá không được < 1000',
    'market-price-validation2': 'Giá không được > 10000000000',
    sku: 'Mã sku',
    'sku-validation': 'Sku bắt buôc',
    variant: 'Phiên bản',
    'variant-validation': 'Phiên bản bắt buộc',
    quantity: 'Số lượng',
    'number-validation': 'Số lượng bắt buộc',
    'number-validation1': 'Số lượng phải > 0',
    'number-validation2': 'Số lượng phải < 9999',
    inStock: 'Tồn kho',
    ...
    video: 'Link video',
    brand: 'Thương hiệu',
    'brand-validation': 'Thương hiệu bắt buôc',
    'brand-add': 'Thêm thương hiệu mới',
    category: 'Danh mục',
    'category-validation': 'Danh mục bắt buôc',
    'category-add': 'Thêm danh mục mới',
    origin: 'Xuất xứ',
    warrantyPeriod: 'Thời gian bảo hàng',
    'warranty-period': 'Thời gian bảo hành',
    'warranty-period-validation': 'Thời gian bảo hành bắt buộc',
    'warranty-period-validation1': 'Thời gian bảo hành >= 0 tháng',
    'warranty-period-validation2': 'Thời gian bảo hành <= 60 tháng',
    ...
    'infor-1-content': 'Tất cả các sản phẩm tại Loc Mobile đều là hàng chính hãng tại Việt Nam',
