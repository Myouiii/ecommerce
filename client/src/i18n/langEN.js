export default {
  common: {
    ...
    'confirm-action-delete': 'Do you want to continue?',
    ...
    'opt-required': 'Please field OTP include 6 numbers',
    'send-back': 'Send back',
    confirm: 'Confirm'
  },
  home: {
    'page-title': 'Genuine cellphone and accessories | Loc Mobile',
    cart: 'Cart',
  ...
  account: {
    ...
    info: 'Info',
    order: 'Order',
    orderHandle: 'Order handled by',
    'order-cancel': 'Order Cancel',
    'order-cancelled': 'Order cancel successfully',
  ...
  cart: {
    'page-title': 'Shopping cart | Loc Mobile',
    title: 'Cart',
  ...
  order: {
    'page-title': 'Orders | Loc Mobile',
    'dashboard-page-title': 'Order Management | Loc Mobile',
    heading: 'Order List',
    title: 'Order',
  ...
  auth: {
    'page-title': {
      login: 'Log in | Loc Mobile',
      register: 'Register | Loc Mobile',
      'reset-password': 'Reset password | Loc Mobile'
    },
    ...
    'accept-terms': 'By registering, I agree to Loc Mobile',
    tos: 'Terms of Service',
    'privacy-policy': 'Privacy Policy',

    'register-salutation': 'Hi, Welcome to Loc Mobile',
  ...
  dashboard: {
    ...
    categories: {
      'page-title': 'Category management | Loc Mobile',
    ...
    brands: {
      'page-title': 'Brand management | Loc Mobile',
      title: 'Brands',
    ...
    discounts: {
      'page-title': 'Discount management | Loc Mobile',
      title: 'Discounts',
    ...
    comments: {
      ...
      'signin-write-comment': 'Sign in to write your review',
    ...
    products: {
      ...
      'name-validation-len': 'Product name must be between 6 and 25 characters long'
    }
  },
  products: {
    'page-title': 'Product management | Loc Mobile',
    title: 'Products',
    list: 'Product list',
    ...
    save: 'Save Changes',
    'add-title': 'Ecommerce: Add new product | Loc Mobile',
    'add-success': 'Successfully added product.',
    edit: 'Edit product',
    'edit-title': 'Ecommerce: Edit new product | Loc Mobile',
    ...
    'market-price-validation1': 'Market Price is < 0',
    'market-price-validation2': 'Market Price is > 10000000000',
    code: 'Product code',
    'code-validation': 'Code is required',
    sku: 'Product sku',
    'sku-validation': 'Sku is required',
    quantity: 'Quantity',
    'number-validation': 'Number is required',
    inStock: 'In Stock',
    ...
    'infor-1-content': 'All products at Loc Mobile are genuine in Vietnam',
