        ...
        { path: 'statics', element: <PageStatistic /> },
        {
          ...
          children: [
            ...
            },
            {
              path: 'users',
              children: [
                { path: '/', element: <Navigate to="/dashboard/users/customer/list" replace /> },
                { path: 'customer/list', element: <PageCustomerList /> },
                { path: 'staff/list', element: <PageStaffList /> },
                { path: '/create', element: <PageUser /> },
...
const PageUser = Loadable(lazy(() => import('../pages/dashboard/users/PageUser')));
const PageUserEdit = Loadable(lazy(() => import('../pages/dashboard/users/PageUserEdit')));
