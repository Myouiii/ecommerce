...
export default function PageCategoryList() {
  ...
  const [list, setList] = useState(categoriesList);
  const requestSearch = (searchedVal) => {
    const filteredRows = categoriesList.filter((row) => row.name.toLowerCase().includes(searchedVal.toLowerCase()));
                        ...
                        return (
                          ...
                          >
                            ...
                            <TableCell align="left">
                              <Label variant="filled" color={isHide ? 'default' : 'success'}>
