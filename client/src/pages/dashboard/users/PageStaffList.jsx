...
import { getAllStaffs, toggleHideUser } from '../../../redux/slices/userSlice';
// ----------------------------------------------------------------------
      ...
      <Container>
        <HeaderBreadcrumbs
          ...
          links={[
            ...
            { name: t('dashboard.users.staff-list') }
          ]}
          action={
            <Button
              variant="contained"
                      ...
                      return (
                        <TableRow hover tabIndex={-1} key={_id} sx={{ cursor: 'pointer' }}>
                          ...
                          <TableCell align="left">
                            ...
                            >
                              {t(`dashboard.users.${status === 'locked' ? 'hidden' : 'visible'}`)}
                            </Label>
                          </TableCell>
