...
import brandsService from '../src/services/brands.service.js';
...
async function insertProduct() {
  ...
  for (let i = productQueue.length - 1; i >= 0; i--) {
    ...
    await brandsService.incCountProduct(product.brand);
    await categoriesService.incCountProduct(product.category);
    await categoriesService.incCountProduct(product.categorySub1);
    await categoriesService.incCountProduct(product.categorySub2);
    await categoriesService.incCountProduct(product.categorySub3);
